...
\vspace{4pt}
\noindent
\textbf{Boxcar | Ruby on Rails Template (Individual)} \hfill 10/2025
\begin{itemize}
    \item Created opinionated Ruby on Rails application template to streamline project initialization
    \item Implemented best practices and common configurations for rapid Rails development
    \item Published as open source project for rapid Rails application scaffolding
\end{itemize}
